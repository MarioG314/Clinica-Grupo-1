    ...
    for (let i = 0; i < pacientes.length+1; i++) {
        if (pacientes.role==="Paciente") {
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="card mb-3">
                                    <div class="row g-0">
                                        ...
                                        <h6>Nombre: ${pacientes[i].firstName}</h6>
                                        <h6>Apellido: ${pacientes[i].lastName}</h6>
            ...
            for (let j = 0; j < consultas.length; j++) {
                if (/* consulta==="pendiente" && */ consulta.UserId===pacientes.id && consulta.categoria===userDr.especialidadUser) {
